...
{
    internal partial class JitCompiler : AbstractHirTraverser
    {
        private void CompileTransformedHir()
        {
            Log.EnsureBlankLine();
            Log.WriteLine("After crosscompilation:");
        ...
        protected override void TraverseConvert(Convert cvt)
        {
            var s = cvt.Type();
            var t = cvt.Type;
        ...
        protected override void TraverseProp(Prop prop)
        {
        ...
        protected override void TraverseApply(Apply apply)
        {
